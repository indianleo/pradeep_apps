...
//export const BaseUrl = "https://rstaging-portal.mychn.org/chn-mobile/public"; 
const baseApiUrl = "https://dw.mychn.org:2009/api";
//const baseApiUrl = "https://rstaging-portal.mychn.org/chn-mobile/public/api";
...
export function checkAppointment(_context, _data) {
    return new Promise((resolve, reject)=> {
        let obj = {
            ...
            "appt_duration": _data.duration,
            "appt_provider": _data.ref_provId,
            "appt_category": _data.am_category,
            "appt_department": _data.am_dept,
            "appt_line": _data.am_line,
            "appt_am_id": _data.am_id,
